...
function buildPrompt($data) {
    ...
    $sections[] = '';
    $sections[] = 'Оцени обоснованность реализации проекта и сформируй ответ СТРОГО в следующем формате (соблюдай переносы строк и разделители ---):';
    $sections[] = '';
    $sections[] = '## Оценка проекта';
    $sections[] = '';
    $sections[] = '[Выбери ОДНУ из оценок и напиши только её]:';
    ...
    $sections[] = '';
    $sections[] = '[Изложи обоснование выбранной оценки кратко, по делу, без лишних слов. Используй конкретные цифры из данных проекта. Укажи сильные стороны, риски и рекомендации.]';
    $sections[] = '';
    $sections[] = '---';
    $sections[] = '';
    $sections[] = 'ВАЖНЫЕ ПРАВИЛА ФОРМАТИРОВАНИЯ:';
    $sections[] = '1. Используй markdown-заголовки ## для разделов.';
    $sections[] = '2. Между разделами "Оценка проекта" и "Краткое обоснование оценки" обязательно ставь разделитель --- на отдельной строке.';
    $sections[] = '3. После заголовка каждого раздела делай пустую строку, затем текст.';
    $sections[] = '4. Не пиши ничего до заголовка "## Оценка проекта" и после обоснования.';
    $sections[] = '';
    $sections[] = 'Пример правильного формата:';
    $sections[] = '## Оценка проекта';
    $sections[] = '';
    $sections[] = 'Рекомендуется с учетом внесения изменений.';
    $sections[] = '';
